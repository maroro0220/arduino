...
volatile int cnt;
void loop() {
 float durationfr, distancefr=100;
 float durationfl, distancefl=100;
 float durationbl, distancebl=100;
 float durationbr, distancebr=100;
...
//======================End==================
  ...
  if(distancefl<30 || distancefr<30) {         //장애물 감지 
  ...
  else if(distancebl<30 || distancebr<30) {         //뒤장애물 감지 
